...
Download `adb_6u05yg3qpvq59_v29836.msi` from release `v73453` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v73453` for pilot groups.
